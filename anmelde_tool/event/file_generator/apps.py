...
class FileGeneratorConfig(AppConfig):
    ...
    name = 'anmelde_tool.event.file_generator'

    def ready(self):
        from anmelde_tool.event.file_generator.models import FileTemplate, GeneratedFiles
        from anmelde_tool.event.file_generator.signals import pre_delete_generate_files, pre_delete_file_template, \
