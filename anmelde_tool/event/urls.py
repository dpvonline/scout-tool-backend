...
router.register(r'my-events', views.EventViewSet, basename='my-events')
router.register(r'my-invitations', views.EventViewSet, basename='my-invitations')
router.register(r'event-read', views.EventViewSet)
...
urlpatterns = [
    ...
    path('', include('anmelde_tool.event.registration.urls')),
